 ...
 * File Link: https://github.com/plone/volto/blob/main/packages/volto/src/components/manage/Blocks/Video/Body.jsx
 * DATE: 2026-04-17
...
const getVideoIDAndPlaceholder = (url, peertubeInstances) => {
  ...
  return { videoID, videoUrl, thumbnailURL, videoSource, hasMatch, listID };
};
        ...
        >
          {hasMatch ? (
            <>
              ...
              {videoSource === 'peertube' && <VideoEmbed {...embedSettings} />}
            </>
          ) : (
            <>
              {data.url.match('.mp4') ? (
